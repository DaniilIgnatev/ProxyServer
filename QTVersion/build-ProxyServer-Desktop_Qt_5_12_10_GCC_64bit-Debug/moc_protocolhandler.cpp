...
#include "../ExecutableProject/Protocol/protocolhandler.h"
...
QT_MOC_LITERAL(4, 43, 12), // "responseData"
QT_MOC_LITERAL(5, 56, 13), // "handleRequest"
QT_MOC_LITERAL(6, 70, 11), // "requestData"
QT_MOC_LITERAL(7, 82, 20), // "shDataSocket_onError"
...
QT_MOC_LITERAL(11, 185, 24) // "shDataSocket_onReadyRead"
    ...
    "QByteArray&\0responseData\0handleRequest\0"
    "requestData\0shDataSocket_onError\0"
...
void ProtocolHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->responseReady((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 1: _t->handleRequest((*reinterpret_cast< QByteArray(*)>(_a[1]))); break;
        case 2: _t->shDataSocket_onError((*reinterpret_cast< QAbstractSocket::SocketError(*)>(_a[1]))); break;
        ...
        {
            using _t = void (ProtocolHandler::*)(QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ProtocolHandler::responseReady)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ProtocolHandler::responseReady(QByteArray & _t1)
{
